<?php include 'tpl/header.tpl.php'; ?>
		...
		<section id="ndpropage" class="ndprosincol clear">
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						<div class="prosinglecol page-postsing mb40 animation" data-animation="animation-fade-in-left">
							<div class="post-content-container">
								<div class="post-image-container">
									<div  class="propage-postslide">
										<div class="item">
											<img src="images/audiovisual-dangi.png" class="img-responsive" alt="blog post image" />
										</div><!--Slide 1 -->
									</div>
