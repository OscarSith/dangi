				...
				<div class="row">
						...
						<div class="prosinglecol page-postsing animation" data-animation="animation-fade-in-left">
							<div class="post-content-container">
								...
								<nav class="ndporpagination">
									<ul class="pager">
										<li class="ndarrowleft"><a href="#"><i class="arrow_left"></i>Previous</a></li>
										<li class="ndarrowright"><a href="#">Next<i class="arrow_right"></i></a></li>
									</ul>
								</nav>
							</div><!--Item 1 -->
					...
					<div class="col-sm-4">
						<div class="ndrightsidebar">
							<!-- .Categories start -->
							<div class="ndprojectover clear animation" data-animation="animation-fade-in-right">
							...
							<div class="ndwidgetshare clear animation" data-animation="animation-fade-in-right">
								...
								<div class="ndsocial-share">
									<ul>
										...
										<li> <a href="#" class="link-mass" title="google"><i class="fa fa-google-plus"></i></a></li>
									</ul>
								</div>
							</div><!-- .NdWidget-Tag end -->
